...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "𝙽𝙰𝙳𝙴𝙴𝙽-𝙼𝙳=fc5ETKxb#F_UoEfijZMKinuGSgKwjPFuj9R8MqEnSuTW6FEMGUDQ", //put your session id
...
READ_MESSAGE: process.env.READ_MESSAGE || "true", //true or false
